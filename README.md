...
Three two-population models are fitted, compared with CLAIC, and given confidence intervals from the Godambe information matrix (100 block-bootstrap replicates). Background, methods and results are in the accompanying [report](dadi_report.pdf).
